...
- 'Gnomint' is based on 'Yaru-Colors' by 'Jannomag' --> [https://github.com/Jannomag/Yaru-Colors](https://github.com/Jannomag/Yaru-Colors)
- 'Mint-Y' is based on 'Moka' by 'Sam Hewitt' --> [https://github.com/snwh/moka-icon-theme](https://github.com/snwh/moka-icon-theme)
